...
## ★ 2026-08-04 갱신 — 다시 열렸다

릴리스 에셋 다운로드가 **다시 200**이 됐고, 실제로 Godot 4.7.1을 받아 헤드리스 테스트와
스크린샷 검증까지 돌렸다. **먼저 받아 보고, 안 될 때만 아래 대체 검증으로 간다**
→ [[godot-install-blocked]] 에 받는 법과 자리표시자 에셋 요령이 정리돼 있다.

아래는 막혀 있던 시절의 기록이다.

## ⚠ 2026-08-03 재확인 — 이 방법은 (당시) 막혀 있었다
