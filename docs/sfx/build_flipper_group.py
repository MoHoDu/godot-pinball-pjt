...
SPECS = {
    ...
    "SFX_Flipper_Activate": (
        [("A2.wav", None, 1.0)], -9.0, 0.150, 0.235, 0.70,
    ...
    "SFX_Flipper_StrongHit": (
        ...
        -4.0, 0.120, 0.185, 0.40,
        "탄력 있는 쫙/팡. 타격보다 밝고 크다"),
    "SFX_Flipper_Parry": (
        [("A6.wav", None, 1.0)], -1.0, 0.100, 0.170, 0.40,
        "명쾌한 탁. 우선순위 1위, 가장 크다"),
}
...
def main():
    ...
    order = ["SFX_Flipper_Select", "SFX_Flipper_Activate",
